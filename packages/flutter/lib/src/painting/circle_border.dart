...
class CircleBorder extends OutlinedBorder {
  ...
  const CircleBorder({ super.side, this.ovalness = 0 }) : assert(side != null);

  /// Defines the percentage amount (0.0-1.0) from which the border will be drawn
  /// to the longest side of a rectangular box, touching all the sides.
  /// When 0.0, it draws a circle. When 1.0, it draws an oval.
  /// This property is ignored when applied to a squared space.
  ...
  ShapeBorder? lerpFrom(ShapeBorder? a, double t) {
    if (a is CircleBorder)
      return CircleBorder(side: BorderSide.lerp(a.side, side, t), ovalness: ui.lerpDouble(a.ovalness, ovalness, t)!);
  ...
  ShapeBorder? lerpTo(ShapeBorder? b, double t) {
    if (b is CircleBorder)
      return CircleBorder(side: BorderSide.lerp(side, b.side, t), ovalness: ui.lerpDouble(ovalness, b.ovalness, t)!);
